  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSave}>
        <div className={`rounded-lg p-6 mb-6 ${sectionBg} ${border} border`}>
          {/* My Personal Details */}
        ...
        <div className={`rounded-lg p-6 mb-6 ${sectionBg} ${border} border`}>
          ...
          <div className="text-xs text-gray-500 mb-2">
            You give us permission to notify this person if we believe you were
            involved in an emergency and to share information about your
