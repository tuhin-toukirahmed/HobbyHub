...
const UpdateGroup = () => {
    ...
    const fetchGroup = async () => {
      ...
      try {
        const res = await fetch(
          `https://hobby-hub-server-site.vercel.app/mygroups/details/${encodeURIComponent(
            groupId
          )}`
        );
        ...
        // Always use the current user's name as host
        setForm({
          ...data,
          email: data.email || email,
          host: user?.displayName || data.host || "",
        });
      } catch (err) {
  ...
  }, [groupId, email, user?.displayName]);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Host name is set to your name"
          />
