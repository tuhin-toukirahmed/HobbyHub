...
// AnimatedFaqItem component to handle individual FAQ items with animations
const AnimatedFaqItem = ({ index, children }) => {
  return (
    <li 
      className="text-left mb-10 reveal-left"
      data-scroll
      data-scroll-class="is-inview"
      data-scroll-repeat="true"
      data-scroll-delay={`${0.05 * (index + 1)}`}
    >
      {children}
    </li>
  );
...
const Faq = () => {
  ...
  return (
    <div>
      <div className={`py-4 ${theme === 'light' ? 'bg-white' : 'bg-gray-900'}`}>
        <div className="max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-between">
          ...
          >
            <p 
              className={`mt-4 text-sm leading-7 ${theme === 'light' ? 'text-gray-500' : 'text-gray-400'} font-regular reveal`}
              data-scroll
              data-scroll-class="is-inview"
            >
              F.A.Q
            ...
            <h3 
              className={`text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight ${theme === 'light' ? 'text-gray-900' : 'text-white'} reveal reveal-delay-100`}
              data-scroll
              data-scroll-class="is-inview"
            >
          ...
          <div className="mt-20" data-scroll>
            <ul className="">
              <li 
                className="text-left mb-10 reveal-left"
                data-scroll
              ...
              >
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className={`${theme === 'light' ? 'bg-gray-100' : 'bg-gray-800'} p-5 px-10 w-full flex items-center`}>
                    <h4 className={`text-md leading-6 font-medium ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>
                      How do I join a hobby group on HobbyHub?
                    </h4>
                  </div>
                </div>

                <div className="flex flex-row items-start">
                  <div className={`${theme === 'light' ? 'bg-indigo-100' : 'bg-indigo-900'} p-5 px-10 w-full flex items-center`}>
                    <p className={`${theme === 'light' ? 'text-gray-700' : 'text-gray-300'} text-sm`}>
                      Joining a hobby group is easy! First, create an account or sign in. Browse through our "All Groups" 
                      section to find groups that match your interests. Once you find a group you like, simply click the 
                      "Join Group" button. You'll immediately gain access to group content, discussions, and activities.
                    </p>
                  </div>
                  <div
              ...
              <li className="text-left mb-10">
                ...
                <div className="flex flex-row items-start">
                  <div className={`${theme === 'light' ? 'bg-indigo-100' : 'bg-indigo-900'} p-5 px-10 w-full flex items-center`}>
                    <p className={`${theme === 'light' ? 'text-gray-700' : 'text-gray-300'} text-sm`}>
                      Absolutely! Any registered member can create a new hobby group. Navigate to the "Create Group" 
                      section, fill out the group details including name, description, category, and upload a cover 
                      image. Once submitted, your group will be live and other members can start joining right away.
                    </p>
                  </div>
                  <div
                    className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
                        ...
                        <g>
                          <g>
                            <path d="M277.462,0.09l-27.681,20.72l-27.838,64.905h-22.386l-8.79-19.048h5.743c10.505,0,19.048-8.452,19.048-18.957V28.571
                              ...
                              c0,14.281,7.233,27.676,19.048,35.595v7.176H51.643L50.9,89.619c-2.314,12.005-2.529,24.343-0.638,36.648l-32.486,57.905
                              l35.876,8.195v60.014h47.619v42.857h114.286v-66.357c33.333-23.581,52.371-61.495,52.343-101.943l0.01-17.371
                              c0-6.548-0.605-13.276-1.824-19.905l-0.705-3.948h-9.348l21.429-51.338V0.09z"></path>
                            <path d="M96.51,123.81c-7.876,0-14.286-4.762-14.286-14.286H72.7c0,14.286,10.681,23.81,23.81,23.81
                              c13.129,0,23.81-9.524,23.81-23.81h-9.524C110.795,119.048,104.386,123.81,96.51,123.81z"></path>
                          </g>
                        </g>
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className={`${theme === 'light' ? 'bg-gray-100' : 'bg-gray-800'} p-5 px-10 w-full flex items-center`}>
                    <h4 className={`text-md leading-6 font-medium ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>
                      How can I find groups related to my hobbies?
                    </h4>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start">
                  <div className={`${theme === 'light' ? 'bg-indigo-100' : 'bg-indigo-900'} p-5 px-10 w-full flex items-center`}>
                    <p className={`${theme === 'light' ? 'text-gray-700' : 'text-gray-300'} text-sm`}>
                      HobbyHub offers multiple ways to discover groups. You can browse our "Popular Groups" section on the homepage,
                      use the search function to find specific interests, or explore the "All Groups" page where you can filter by 
                      categories such as art, music, sports, technology, and more. We also provide personalized recommendations 
              ...
              <li className="text-left mb-10">
                <div className="flex flex-row items-start mb-5">
                  ...
                  <div className={`${theme === 'light' ? 'bg-gray-100' : 'bg-gray-800'} p-5 px-10 w-full flex items-center`}>
                    <h4 className={`text-md leading-6 font-medium ${theme === 'light' ? 'text-gray-900' : 'text-white'}`}>
                      Are there membership fees to join groups?
                    </h4>
                  </div>
                </div>
                ...
                <div className="flex flex-row items-start">
                  <div className={`${theme === 'light' ? 'bg-indigo-100' : 'bg-indigo-900'} p-5 px-10 w-full flex items-center`}>
                    <p className={`${theme === 'light' ? 'text-gray-700' : 'text-gray-300'} text-sm`}>
                      HobbyHub is completely free to use! There are no membership fees to join our platform or to become a member 
                      of any hobby group. Some groups might organize paid events or activities, but joining the groups themselves 
                      is always free. We believe connecting people through shared interests should be accessible to everyone.
                    </p>
                  </div>
                  <div
                    className="hidden sm:flex items-center justify-center p-3 ml-3 rounded-full bg-indigo-500 text-white border-4 border-white text-xl font-semibold">
