...
const Footer = () => {  return (
    <div 
      className="pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl"
      data-scroll-section
    >
      <div 
      ...
      >
        <div 
          className="sm:col-span-2 reveal-left"
          data-scroll
      ...
      <div 
        className="flex flex-col-reverse justify-between pt-5 pb-10 border-t lg:flex-row reveal-fade"
        data-scroll
        data-scroll-class="is-inview"
